...
import Chinese from '@linehub/locale/lang/zh-cn';
import { buildProps, definePropType } from '@linehub/utils/props';
import type { MaybeRef } from '@vueuse/core';
import type { InjectionKey, Ref } from 'vue';
import type { Language } from '@linehub/locale';
...
// refer to: https://github.com/linehub/linehub/issues/2610#issuecomment-887965266
...
export const useLocale = () => {
  return inject(
    localeContextKey,
    localeContextCache || localeProviderMaker(Chinese)
  );
};
